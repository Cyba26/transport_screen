...
// --- API proxy (remplace l'ancienne fonction serverless Vercel api/proxy.js) ---
...
// --- Fichiers statiques (index.html, img/, ...) ---
app.use(express.static(__dirname));

// Fallback SPA : toute autre route renvoie index.html (remplace les rewrites de vercel.json)
app.use((req, res) => {
  res.sendFile(join(__dirname, 'index.html'));
});

app.listen(PORT, () => {
  console.log(`Transport screen running on port ${PORT}`);
});
